...
class UniprotMappingTest(unittest.TestCase):
    ...
    def test_mu_map(self):
        c.mu_map() #TODO: Modify mu_map() in ymap.py to take mutation.txt and yeastID.txt as arguments
...
#         self.assertTrue(filecmp.cmp(self.summary, ref_summary))
    ...
    def test_mmap(self):
        c.mmap(self.sites_id, self.mutation_prot) #TODO: Consistency of order in which parameters are listed (see following test method for comparison)
